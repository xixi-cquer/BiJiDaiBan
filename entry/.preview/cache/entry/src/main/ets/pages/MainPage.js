...
class MainPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Stack.create();
            Stack.debugLine("pages/MainPage.ets(101:5)");
            Stack.width(CommonConstants.FULL_WIDTH);
            Stack.height(CommonConstants.FULL_HEIGHT);
            Stack.backgroundColor({ "id": 16777224, "type": 10001, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
            if (!isInitialRender) {
                Stack.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/MainPage.ets(102:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/MainPage.ets(104:11)");
            if (!isInitialRender) {
                Row.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('笔记');
            Text.debugLine("pages/MainPage.ets(105:13)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // })
            Text.create('   ');
            Text.debugLine("pages/MainPage.ets(113:13)");
            if (!isInitialRender) {
                // .onClick(()=>{
                //   router.pushUrl({url:'pages/MainPage'})
                // })
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('待办');
            Text.debugLine("pages/MainPage.ets(114:13)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/MainPage.ets(128:11)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/MainPage.ets(140:9)");
            Row.width(CommonConstants.FULL_WIDTH);
            Row.padding({ left: { "id": 16777300, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" }, right: { "id": 16777300, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" } });
            Row.margin({ top: { "id": 16777304, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" }, bottom: { "id": 16777304, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" } });
            if (!isInitialRender) {
                Row.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Search.debugLine("pages/MainPage.ets(141:11)");
            Search.width(CommonConstants.FULL_WIDTH);
            Search.borderRadius({ "id": 16777313, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
            Search.borderWidth({ "id": 16777288, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
            Search.borderColor({ "id": 16777225, "type": 10001, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
            Search.placeholderFont({ size: { "id": 16777307, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" } });
            Search.textFont({ size: { "id": 16777307, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" } });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.width(CommonConstants.FULL_WIDTH);
            Row.padding({ left: { "id": 16777300, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" }, right: { "id": 16777300, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" } });
            Row.margin({ top: { "id": 16777305, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" } });
            if (!isInitialRender) {
                Row.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            List.debugLine("pages/MainPage.ets(173:11)");
            List.width(CommonConstants.FULL_WIDTH);
            List.borderRadius({ "id": 16777312, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
            ...
            const forEachItemGenFunction = _item => {
                const item = _item;
                {
                    ...
                    const itemCreation = (elmtId, isInitialRender) => {
                        ...
                        ListItem.height({ "id": 16777290, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
                        ListItem.onClick(() => {
                        ...
                        Gesture.pop();
                        ListItem.debugLine("pages/MainPage.ets(175:15)");
                        if (!isInitialRender) {
                            ListItem.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
                    ...
                    const observedDeepRender = () => {
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                            Row.create();
                            Row.debugLine("pages/MainPage.ets(176:17)");
                            Row.width(CommonConstants.FULL_WIDTH);
                            Row.padding({ left: { "id": 16777300, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" }, right: { "id": 16777300, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" } });
                            if (!isInitialRender) {
                                Row.pop();
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            Image.debugLine("pages/MainPage.ets(177:19)");
                            Image.height(Constants.FULL_PERCENT);
                            Image.aspectRatio(1);
                            Image.objectFit(ImageFit.Cover);
                            Image.borderRadius({ "id": 16777338, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
                            if (!isInitialRender) {
                                Image.pop();
                            }
                            ViewStackProcessor.StopGetAccessRecording();
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                            Column.create();
                            Column.debugLine("pages/MainPage.ets(182:19)");
                            Column.width('60%');
                            if (!isInitialRender) {
                                Column.pop();
                            }
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                            Row.create();
                            Row.debugLine("pages/MainPage.ets(183:21)");
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("pages/MainPage.ets(184:23)");
                            ...
                            Text.layoutWeight(1);
                            Text.maxLines(1);
                            Text.lineHeight({ "id": 16777352, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
                            Text.fontFamily({ "id": 16777256, "type": 10003, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
                            Text.margin({ left: { "id": 16777344, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" } });
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("pages/MainPage.ets(198:21)");
                            Text.fontSize({ "id": 16777329, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
                            Text.fontFamily({ "id": 16777255, "type": 10003, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
                            Text.opacity(Constants.DESC_OPACITY);
                            Text.fontColor({ "id": 16777236, "type": 10001, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
                            Text.lineHeight({ "id": 16777330, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                            Blank.create();
                            Blank.debugLine("pages/MainPage.ets(211:19)");
                            ...
                            if (this.isEdit) {
                                this.ifElseBranchUpdateFunction(0, () => {
                                    this.observeComponentCreation((elmtId, isInitialRender) => {
                                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                        Row.create();
                                        Row.debugLine("pages/MainPage.ets(215:21)");
                                    ...
                                    this.observeComponentCreation((elmtId, isInitialRender) => {
                                        ...
                                        Toggle.debugLine("pages/MainPage.ets(216:23)");
            ...
            if (!this.isEdit) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("pages/MainPage.ets(279:9)");
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("pages/MainPage.ets(280:11)");
                        if (!isInitialRender) {
                            Image.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
            ...
            if (this.isEdit) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Button.createWithChild();
                        Button.debugLine("pages/MainPage.ets(301:9)");
                        Button.width({ "id": 16777293, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
                        Button.height({ "id": 16777293, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
                        Button.backgroundColor({ "id": 16777224, "type": 10001, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
                        Button.markAnchor({ x: { "id": 16777311, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" }, y: CommonConstants.MINIMUM_SIZE });
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("pages/MainPage.ets(302:11)");
                        if (!isInitialRender) {
                            Image.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
